...
public class DimensionLocatorScreen extends Screen {
    ...
    protected void init() {
        ...
        this.listWidget = new DimensionListWidget(this.minecraft, listWidth, this.height, listY, listY + listHeight, 40,
                listX);
        ...
        if (this.minecraft != null && this.minecraft.getConnection() != null) {
            for (net.minecraft.client.multiplayer.PlayerInfo info : this.minecraft.getConnection().getOnlinePlayers()) {
                if (this.dimensions.containsKey(info.getProfile().getId())) {
                    this.listWidget.addPlayerEntry(new DimensionEntry(info, info.getProfile().getName(),
                            this.dimensions.get(info.getProfile().getId())));
                }
            }
        }
    ...
    public class DimensionEntry extends ObjectSelectionList.Entry<DimensionEntry> {
        ...
        public DimensionEntry(net.minecraft.client.multiplayer.PlayerInfo playerInfo, String displayName,
        ...
        public void render(GuiGraphics graphics, int index, int top, int left, int width, int height, int mouseX,
            ...
            net.minecraft.network.chat.MutableComponent dimComponent = net.minecraft.network.chat.Component
            ...
            graphics.drawString(DimensionLocatorScreen.this.font, dimText,
                    left + width - 10 - DimensionLocatorScreen.this.font.width(dimText), top + 16, 0xFF000000
                            | Integer.parseInt(dev.ClasherHD.bodycam.config.ModClientConfig.COLOR_DIMENSION.get(), 16));
        }
